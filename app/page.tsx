...
import { LEGAL_MEMBERSHIP_STATUS, STATUS_LINE, THESIS } from "@/legal/documents";
 ...
 * traffic.
 *
 * The cost is staleness of up to 60 seconds on a public projection,
...
interface LedgerRow {
  ordinal: number;
  name: string;
  /** ISO-8601 instant for <time datetime>, or null when unknown. */
  enteredIso: string | null;
  /** Pre-rendered display form, e.g. "26 AUG 2026". */
  enteredLabel: string;
...
/** Normalize whatever the driver returns into the two strings a row renders. */
function enteredFields(
  value: Date | string | null,
): Pick<LedgerRow, "enteredIso" | "enteredLabel"> {
  const date = value === null ? null : value instanceof Date ? value : new Date(value);
  if (date === null || Number.isNaN(date.getTime())) return { enteredIso: null, enteredLabel: "-" };
  const day = String(date.getUTCDate()).padStart(2, "0");
  return {
    enteredIso: date.toISOString(),
    enteredLabel: day + " " + MONTHS[date.getUTCMonth()] + " " + date.getUTCFullYear(),
  };
}
...
const DECLARED_ORIGIN_ROW: LedgerRow = {
  ordinal: 1,
  name: "RADO",
  ...enteredFields(new Date("2026-08-26T00:00:00Z")),
...
function LedgerRowView({ row }: { row: LedgerRow }) {
  return (
    <tr>
      <td>
        <strong>{String(row.ordinal).padStart(6, "0")}</strong>
      </td>
      <td>{row.name}</td>
      <td>
        {row.enteredIso ? (
          <time dateTime={row.enteredIso}>{row.enteredLabel}</time>
        ) : (
          row.enteredLabel
        )}
      </td>
  ...
  return (
    <>
      <a className="skip-link" href="#main">
        Skip to the founding instrument
      </a>
      ...
      <main id="main">
        <section className="founding-field" id="top" aria-labelledby="founding-statement">
          ...
          <h1 id="founding-statement">
            ...
            <span>EVERYTHING ELSE</span> <span>CAN BE BUILT.</span>
          </h1>
          <div className="thesis-strip">
            <p>{THESIS}</p>
            <p className="sr-only">{STATUS_LINE}</p>
            <dl>
              <div>
                <dt>OWNERSHIP</dt>
                <dd>COMMITTED</dd>
        ...
        <section className="ledger" id="ledger" aria-labelledby="ledger-title">
          <div className="section-heading">
            ...
            <p className="protocol-note">
              A successor activates the connection—not your right to belong.
            </p>
          </div>
          ...
          <div className="table-scroll">
            <table className="ledger-table">
              <caption className="sr-only">
                Founding Ledger record{live ? "" : " (declared origin; ledger not open)"}
              </caption>
              <thead>
                <tr>
                  <th scope="col">NO.</th>
          ...
          <div className="next-place">
            <div>
              ...
              <p>
                Your number is assigned only when a verified entry is sealed. Nothing is reserved.
                Nothing is sold.
              </p>
            </div>
            <a className="enter-button" href="/enter">
              ENTER THE FOUNDING LEDGER <span aria-hidden="true">↘</span>
            </a>
          </div>
          {!live && (
            <p className="neutral-note">
              THE SHARED LEDGER IS NOT OPEN IN THIS ENVIRONMENT. THE ROW ABOVE IS THE DECLARED
              ORIGIN OF THE FORMATION STORY - NOT A CANONICAL DATABASE EVENT.
            </p>
          )}
        </section>
        ...
        <section className="entry-instrument ink-section" id="entry" aria-labelledby="entry-title">
          <div className="entry-copy">
            ...
            <p className="large-copy">
              Entry verifies your email, shows you exactly what you accept, and assigns a public
              number only inside one committed transaction. A Founding Ledger entry is not legal
              membership.
            </p>
            <ol className="relay-sequence" aria-label="Founding Relay sequence">
              ...
              <li>
                <b>02</b>
                <span>YOUR RELAY OPENS</span>
              </li>
              <li>
                <b>03</b>
                <span>ANOTHER HUMAN CONTINUES</span>
              </li>
              <li>
                <b>04</b>
                <span>THE EDGE IS RECORDED</span>
              </li>
            </ol>
          </div>
          ...
          <div className="entry-panel">
            <form action="/enter" method="get">
              <label className="field-label" htmlFor="enter-overview">
                WHAT ENTRY REQUIRES
              </label>
              <ol className="enter-steps">
                <li>
                  <b>01</b>
                  <span>Verify control of your email with a magic link.</span>
                </li>
                <li>
                  <b>02</b>
                  <span>Choose a public name or pseudonym.</span>
                </li>
                <li>
                  <b>03</b>
                  <span>Read and accept the declaration and current versions.</span>
                </li>
                <li>
                  <b>04</b>
                  <span>Seal. The transaction assigns your number at commit.</span>
                </li>
              </ol>
              <button className="action-button inverse" type="submit">
                BEGIN VERIFIED ENTRY <span aria-hidden="true">→</span>
              </button>
        ...
        <section className="tapes" id="tapes" aria-labelledby="tapes-title">
          <div className="section-heading compact-heading">
            ...
            <p className="protocol-note">
              Not a raw terminal replay. Input, authority, change, test and result.
            </p>
          </div>
            ...
            <section className="tape-column" aria-labelledby="formation-tape-title">
              ...
              <ol className="event-list">
                <li>
                  ...
                  <div>
                    <strong>FOUNDING THESIS ADOPTED</strong>
                    <span>Founder-steward project decision</span>
                  </div>
                  <b>RECORDED</b>
                </li>
                <li>
                  <time dateTime="2026-08-26">DAY 1</time>
                  <div>
                    <strong>CONSTITUTION 0.1 OPERATIVE</strong>
                    <span>Member ratification not yet possible</span>
                  </div>
                  <b>CHARTER</b>
                </li>
                <li>
            ...
            <section className="tape-column" aria-labelledby="build-tape-title">
              ...
              <details open>
                ...
                <dl className="build-fields">
                  <div>
                    <dt>INPUT</dt>
                    <dd>A frontend preview cannot make participation honest by itself.</dd>
                  </div>
                  <div>
                    <dt>DECISION</dt>
                    <dd>Build the verified entry ritual on a real database.</dd>
                  </div>
                  <div>
                    <dt>CHANGE</dt>
                    <dd>Next.js application, PostgreSQL ledger, atomic seal, signed relays.</dd>
                  </div>
                  <div>
                    <dt>TRUTH</dt>
              ...
              <details>
                <summary>
                  <span>D1.2</span> Reservation becomes an atomic seal{" "}
                  <b>SPECIFIED → IMPLEMENTED</b>
                </summary>
                <dl className="build-fields">
                  <div>
                    <dt>INPUT</dt>
                    <dd>A 15-minute reservation fails under viral concurrency.</dd>
                  </div>
                  <div>
                    <dt>DECISION</dt>
                    <dd>Assign at verified commit; the first successor activates only the edge.</dd>
                  </div>
                  <div>
                    <dt>CHANGE</dt>
                    <dd>Row-locked ordinal allocator plus atomic First Continuation race.</dd>
                  </div>
                  <div>
                    <dt>TRUTH</dt>
              ...
              <details>
                <summary>
                  <span>D1.3</span> Social reach returns as evidence <b>SPECIFIED</b>
                </summary>
                <dl className="build-fields">
                  <div>
                    <dt>INPUT</dt>
                    <dd>
                      Discussion on X and LinkedIn can create reach, but the network needs the
                      result.
                    </dd>
                  </div>
                  <div>
                    <dt>DECISION</dt>
                    <dd>Outsource reach, never memory or authority.</dd>
                  </div>
                  <div>
                    <dt>CHANGE</dt>
                    <dd>Define canonical case files, structured responses and agent digests.</dd>
                  </div>
                  <div>
                    <dt>TRUTH</dt>
                    <dd>Specification shipped. External ingestion remains unbuilt.</dd>
                  </div>
                </dl>
              </details>
            </section>
        ...
        <section
          className="constitution ink-section"
          id="constitution"
        ...
        >
          <div className="section-heading compact-heading">
            ...
            <a className="document-link inverse-link" href="/source/CONSTITUTION-0.1.md">
              READ CONSTITUTION 0.1 <span aria-hidden="true">↗</span>
            </a>
          </div>

          <div className="diff" aria-label="Founding direction change">
            <p className="removed">
              <span>−</span> The first public product is a Mission Market of cells.
            </p>
            <p className="added">
              <span>+</span> The first public product is the network forming itself in public.
            </p>
            <p className="removed">
              <span>−</span> Everything can be built. What should become ours?
            </p>
            <p className="added">
              <span>+</span> THE NETWORK IS OURS. EVERYTHING ELSE CAN BE BUILT.
            </p>
            <p className="removed">
              <span>−</span> Public momentum leads the first experience.
            </p>
            <p className="added">
              <span>+</span> Chronology, causal participation and legal truth lead.
            </p>
            <p className="added">
              <span>+</span> Another person activates the edge—not your belonging.
            </p>
            <p className="added">
              <span>+</span> External networks distribute; OURS remembers and decides.
            </p>
          </div>
          ...
          <div className="constitution-status">
            <div>
              <span>AUTHORITY</span>
              <strong>FOUNDER-STEWARD ADOPTED</strong>
            </div>
            <div>
              <span>MEMBER RATIFICATION</span>
              <strong>NOT YET POSSIBLE</strong>
            </div>
            <div>
              <span>LEGAL REVIEW</span>
              <strong>REQUIRED BEFORE 1.0</strong>
            </div>
          </div>
        </section>
        ...
        <section className="decision" id="decision" aria-labelledby="decision-title">
          ...
          <div className="case-main">
            ...
            <p className="large-copy">
              Proposed: when Constitution 1.0 is validly ratified—not when an arbitrary counter
              fills.
            </p>
            ...
            <div className="case-arguments">
              <div>
                <h3>CASE FOR</h3>
                <p>
                  It turns founding status into a constitutional job, avoids artificial scarcity and
                  lets low ledger numbers preserve chronology.
                </p>
              </div>
              <div>
                <h3>CASE AGAINST</h3>
                <p>
                  Legal work could delay the end indefinitely, and people may enter under materially
                  different drafts.
                </p>
              </div>
              <div>
                ...
                <p>
                  Legal feasibility, disclosure clarity, expected timeline and a fair transition if
                  membership issuance is delayed.
                </p>
              </div>
            </div>
        ...
        <section className="source-package" id="source" aria-labelledby="source-title">
          <div className="section-heading compact-heading">
            ...
            <p className="protocol-note">
              No hidden product deck. Adopted decisions, hypotheses and missing infrastructure are
              explicit.
            </p>
          </div>

          <nav className="document-list" aria-label="OURS source documents">
            <a href="/source/OURS.md">
              <span>01</span>
              <strong>OURS · FOUNDING DIRECTION V0.2</strong>
              <em>ADOPTED</em>
            </a>
            <a href="/source/CONSTITUTION-0.1.md">
              <span>02</span>
              <strong>FOUNDING CONSTITUTION 0.1</strong>
              <em>OPERATIVE CHARTER</em>
            </a>
            ...
            <a href="/source/PROPOSAL-AND-DELIBERATION-PROTOCOL.md">
              <span>04</span>
              <strong>PROPOSAL + DELIBERATION PROTOCOL</strong>
              <em>SPECIFIED · NOT BUILT</em>
            </a>
            <a href="/source/AGENT-BUILD-CONTRACT.md">
              <span>05</span>
              <strong>AGENT BUILD CONTRACT</strong>
              <em>ADOPTED</em>
            </a>
            ...
            <a href="/source/OURS-v0.1.md">
              <span>07</span>
              <strong>PREHISTORY · FOUNDING DIRECTION V0.1</strong>
              <em>SUPERSEDED</em>
            </a>
            <a href="/status">
              <span>08</span>
            ...
            <a href="/source/FOUNDING-LEDGER-BUILD-HANDOFF.md">
              <span>09</span>
              <strong>FOUNDING LEDGER BUILD HANDOFF</strong>
              <em>AUTHORIZED BUILD PLAN</em>
            </a>
            <a href="/source/FOUNDING-LEDGER-NEXT-SESSION-PROMPT.md">
              <span>10</span>
