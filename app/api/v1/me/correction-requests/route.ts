...
export async function POST(req: Request) {
  ...
  if (!parsed.success) return jsonError("INVALID_INPUT", "Check the proposed name and idempotency key.", 400);
  ...
  if (dupes[0]) return jsonError("ALREADY_REQUESTED", "This exact correction is already open.", 409);
